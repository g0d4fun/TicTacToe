...
public class AlphaBetaPruningAI {
            ...
            for (int j = 0; j < Constants.COLUMNS; j++) {
                if (board[i][j].equals(EPlayerType.EMPTY)) {
                    ...
                    if (score > alpha) {
                        ...
                        rowBestMoveIndex = i;
                        colBestMoveIndex = j;
                    } else if (score == alpha && (((int) (Math.random() * 50 + 1)) > 25)) {
                        //Random 50% pass no next position
                        alpha = score;
                        rowBestMoveIndex = i;
                        colBestMoveIndex = j;
                    }
            ...
            for (int j = 0; j < Constants.COLUMNS; j++) {
                if (board[i][j].equals(EPlayerType.EMPTY)) {
                    ...
                    if (score < beta) {
                        ...
                        rowBestMoveIndex = i;
                        colBestMoveIndex = j;
                    } else if (score == beta && (((int) (Math.random() * 50 + 1)) > 25)) {
                        //Random 50% pass no next position
                        beta = score;
                        rowBestMoveIndex = i;
                        colBestMoveIndex = j;
    ...
    private int randomIntegerInterval(int min, int max) {
